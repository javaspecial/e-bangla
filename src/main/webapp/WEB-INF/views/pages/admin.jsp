					...
					<li class="treeview"><a href="#"> <i class="fa fa-book"></i>
						...
						<ul class="treeview-menu">
							<li class="treeview"><a href="#"><i
									class="fa fa-circle-o"></i> Menu categories<span
									class="pull-right-container"> <i
										class="fa fa-angle-left pull-right"></i>
								</span> </a>
								<ul class="treeview-menu">
									<li class="treeview"><a href="#"><i
											class="fa fa-circle-o"></i> Menu groups <span
											class="pull-right-container"> <i
												class="fa fa-angle-left pull-right"></i>
										</span> </a>
										<ul class="treeview-menu">
											<li><a href="#"><i class="fa fa-circle-o"></i> Menu
													items</a></li>
										</ul></li>
								</ul></li>
							<li class="treeview"><a href="#"><i
									class="fa fa-circle-o"></i> Modifier groups<span
									class="pull-right-container"> <i
										class="fa fa-angle-left pull-right"></i>
								</span> </a>
								<ul class="treeview-menu">
									<li class="treeview"><a href="#"><i
											class="fa fa-circle-o"></i> Modifiers <span
											class="pull-right-container"> </span> </a></li>
								</ul></li>
							<hr class="modifierAndtaxSeparation">
							<li><a href="#"><i class="fa fa-circle-o"></i>Tax</a></li>
							<li><a href="#"><i class="fa fa-circle-o"></i>Shifts</a></li>
							<li><a href="#"><i class="fa fa-circle-o"></i>Multipliers</a></li>
							<li><a href="#"><i class="fa fa-circle-o"></i>Order
									types</a></li>
							<li><a href="#"><i class="fa fa-circle-o"></i>Closed
									tickets</a></li>
							<li><a href="#"><i class="fa fa-circle-o"></i>Attendance
									history</a></li>
							<li><a href="#"><i class="fa fa-circle-o"></i>Coupons &
									discounts</a></li>
							<li><a href="#"><i class="fa fa-circle-o"></i>Cooking
									instructions</a></li>
						</ul></li>
		...
		<div class="verticalScrollbar">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<h1>
						Dashboard <small>Version 1.0.1</small>
					</h1>
					<ol class="breadcrumb">
										...
										<div class="box-body">
											...
											<div class="direct-chat-messages">
												...
												<div class="direct-chat-msg">
													...
													<img class="direct-chat-img"
														src="<spring:url value="/resources/admin/img/user1-128x128.jpg" />"
											...
											<div class="direct-chat-contacts">
												<ul class="contacts-list">
													...
													<!-- End Contact Item -->
													<li><a href="#"> <img class="contacts-list-img"
															src="<spring:url value="/resources/admin/img/user7-128x128.jpg" />"
															alt="User Image">
													...
													<!-- End Contact Item -->
													<li><a href="#"> <img class="contacts-list-img"
															src="<spring:url value="/resources/admin/img/user5-128x128.jpg" />"
															alt="User Image">
													...
													<!-- End Contact Item -->
													<li><a href="#"> <img class="contacts-list-img"
															src="<spring:url value="/resources/admin/img/user6-128x128.jpg" />"
															alt="User Image">
													...
													<!-- End Contact Item -->
													<li><a href="#"> <img class="contacts-list-img"
															src="<spring:url value="/resources/admin/img/user8-128x128.jpg" />"
															alt="User Image">
									...
									<ul class="products-list product-list-in-box">
										<li class="item">
											<div class="product-img">
												<img
													src="<spring:url value="/resources/admin/img/default-50x50.gif" />"
													alt="Product Image">
											</div>
